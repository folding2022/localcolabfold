...
conda install -c conda-forge python=3.10 cudatoolkit==11.6.0 openmm==7.7.0 pdbfixer -y
...
colabfold-conda/bin/python3.10 -m pip install --no-warn-conflicts "colabfold[alphafold-minus-jax] @ git+https://github.com/folding2022/ColabFold@beta" tensorflow==2.12.0
colabfold-conda/bin/python3.10 -m pip install https://storage.googleapis.com/jax-releases/nocuda/jaxlib-0.3.25-cp310-cp310-manylinux2014_x86_64.whl
